...
countDownDate = new Date("2022-05-02").getTime();
var now = new Date().getTime();
var distance = countDownDate - now;
var dayss = Math.floor(distance / (1000 * 60 * 60 * 24));
var hourss = Math.floor((distance % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60));
var minutess = Math.floor((distance % (1000 * 60 * 60)) / (1000 * 60));
var secondss = Math.floor((distance % (1000 * 60)) / 1000);
Fitri = `${dayss}Hari ${hourss}Jam ${minutess}Menit ${secondss}Detik`
...
var minutess = Math.floor((distance % (1000 * 60 * 60)) / (1000 * 60));
var secondss = Math.floor((distance % (1000 * 60)) / 1000);
puasa = `${dayss}Hari ${hourss}Jam ${minutess}Menit ${secondss}Detik`
...
var minutess = Math.floor((distance % (1000 * 60 * 60)) / (1000 * 60));
var secondss = Math.floor((distance % (1000 * 60)) / 1000);
Adha = `${dayss}Hari ${hourss}Jam ${minutess}Menit ${secondss}Detik`

countDownDate = new Date("2022-04-13").getTime();
var now = new Date().getTime();
var distance = countDownDate - now;
var dayss = Math.floor(distance / (1000 * 60 * 60 * 24));
var hourss = Math.floor((distance % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60));
var minutess = Math.floor((distance % (1000 * 60 * 60)) / (1000 * 60));
var secondss = Math.floor((distance % (1000 * 60)) / 1000);
ultah = `${dayss}Hari ${hourss}Jam ${minutess}Menit ${secondss}Detik`
...
const body = (type === 'listResponseMessage' && mek.message.listResponseMessage.title) ? mek.message.listResponseMessage.title : (type === 'buttonsResponseMessage' && mek.message.buttonsResponseMessage.selectedButtonId) ? mek.message.buttonsResponseMessage.selectedButtonId : (type === 'conversation' && mek.message.conversation.startsWith(prefix)) ? mek.message.conversation : (type == 'imageMessage') && mek.message.imageMessage.caption.startsWith(prefix) ? mek.message.imageMessage.caption : (type == 'videoMessage') && mek.message.videoMessage.caption.startsWith(prefix) ? mek.message.videoMessage.caption : (type == 'extendedTextMessage') && mek.message.extendedTextMessage.text.startsWith(prefix) ? mek.message.extendedTextMessage.text : (type == 'stickerMessage') && (getCmd(mek.message.stickerMessage.fileSha256.toString('base64')) !== null && getCmd(mek.message.stickerMessage.fileSha256.toString('base64')) !== undefined) ? getCmd(mek.message.stickerMessage.fileSha256.toString('base64')) : ""
    ...
    const isAntilinkwame = isGroup ? antilinkwame.includes(from) : false;
...
const checkRegisteredUser = (sender) => {
    ...
    const ownerNumber = [`6285725220424@s.whatsapp.net`]
...
cmhit.push(command)
    //MESS
    mess = {
      wait: "[ ♲︎︎︎ ] 𝙼𝙾𝙷𝙾𝙽 𝚃𝚄𝙽𝙶𝙶𝚄 𝚂𝙴𝙱𝙴𝙽𝚃𝙰𝚁...",
      success: "[ ✔︎ ] 𝚂𝚄𝙺𝚂𝙴𝚂...",
      wrongFormat: "[ ⚠︎ ] 𝙵𝙾𝚁𝙼𝙰𝚃 𝚂𝙰𝙻𝙰𝙷, 𝚂𝙸𝙻𝙰𝙷𝙺𝙰𝙽 𝙲𝙾𝙱𝙰 𝙻𝙰𝙶𝙸 𝙳𝙸 𝙼𝙴𝙽𝚄...",
      error: {
        stick: "[ ⚠︎ ] 𝙸𝚃𝚄 𝙱𝚄𝙺𝙰𝙽 𝚂𝚃𝙸𝙺𝙴𝚁...",
        apiz: "[ ⚠︎ ] 𝙴𝚁𝚁𝙾𝚁, 𝚂𝙸𝚂𝚃𝙴𝙼 𝙰𝙿𝙸𝙺𝙴𝚈 𝚃𝙴𝙻𝙰𝙷 𝙴𝚇𝙿𝙸𝚁𝙴𝙳...",
        Iv: "[ ⚠︎ ] 𝙻𝙸𝙽𝙺 𝙴𝚁𝚁𝙾𝚁, 𝙹𝙰𝙽𝙶𝙰𝙽 𝙺𝙸𝚁𝙸𝙼 𝙻𝙸𝙽𝙺 𝙶𝙹 𝚃𝙾𝙳 :𝚅...",
      },
      only: {
        group: "[ ☹ ] 𝙷𝙰𝙽𝚈𝙰 𝙱𝙸𝚂𝙰 𝙳𝙸 𝙶𝚄𝙽𝙰𝙺𝙰𝙽 𝙳𝙸 𝙶𝚁𝙾𝚄𝙿...︎",
        owner: "[ ☹︎ ] 𝙷𝙰𝙽𝚈𝙰 𝙱𝙸𝚂𝙰 𝙳𝙸 𝙶𝚄𝙽𝙰𝙺𝙰𝙽 𝙾𝚆𝙽𝙴𝚁...
      },
    };
...
/*const reply = (teks) => {
			xeon.sendMessage(from, teks, text, { thumbnail: iye, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jam} - ${week} ${weton} - ${date}`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/6285725220424?text=hello`}}})
		}*/
...
xeon.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
    ...
    const add = function (from, orangnya) {
      xeon.groupAdd(from, orangnya);
        ...
        const grupinv = (teks) => {
        	grup = xeon.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx', "groupName": `ᴀɴᴅɪɢᴀɴᴢ Bot Ofc.`, "footerText": "*_ᴀɴᴅɪɢᴀɴᴢ_*", "jpegThumbnail": iye, "caption": teks}}, {quoted:mek})
...
const fakeitem = (teks) => {
        ...
        participant:`0@s.whatsapp.net`, ...(from ? {
remoteJid :"6289523258649-1604595598@g.us" }: {})
                    },message:{"orderMessage":{"orderId":"174238614569481","thumbnail":fs.readFileSync(`./stik/thumb.jpeg`),"itemCount":10,"status":"INQUIRY","surface":"CATALOG","message":`ᴀɴᴅɪɢᴀɴᴢ 😎`,"token":"AR6xBKbXZn0Xwmu76Ksyd7rnxI+Rx87HfinVlW4lwXa6JA=="}}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true})}
// Katalog
const reply = (teks) => {
             res = xeon.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 111119999, "message": teks, "footerText": "*ᴀɴᴅɪɢᴀɴᴢ*", "thumbnail": bgg, "surface": 'CATALOG' }}, {quoted:ftrol})
             xeon.relayWAMessage(res)
        }
const fakewa = (teks) => {        
xeon.sendMessage(from, teks, text, { thumbnail: fake, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `ᴀɴᴅɪɢᴀɴᴢ`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/6285725220424?text=hello`}}})
		}
...
sendEphemeral: false,
"externalAdReply": {
                "title": `Whatsapp-BOT\nᴀɴᴅɪɢᴀɴᴢ😎. (@nnda.krnwn_) •Instagram photos and Videos`,
                "body": "",
                "previewType": "PHOTO",
...
"externalAdReply": {
                "title": `Whatsapp`,
                "body": `wa.me/6285725220424`,
                "mediaType": "10",
                "mediaUrl": `wa.me/6285725220424`,
                "thumbnailUrl": "https://i.ibb.co/y0RYgzB/FB-IMG-1635413002830.jpg",
                "thumbnail": iye,
                "sourceUrl": `wa.me/6285725220424`,
...
async function sendFileFromUrl(from, url, caption, msg, men) {
    ...
    if (isGroup && !isVote) {
      if (budy.toLowerCase() === "vote") {
        ...
        let id_vote = sender ? sender : "6285725220424@s.whatsapp.net";
    ...
    if (isGroup && isAntilink && !mek.key.fromMe) {
      if (budy.includes("://chat.whatsapp.com/")) {
        if (isGroupAdmins) return reply("𝑨𝒅𝒎𝒊𝒏 𝒎𝒂𝒉 𝒃𝒆𝒃𝒂𝒔");
        reply("𝐋𝐈𝐍𝐊 𝐆𝐑𝐔𝐏 𝐃𝐄𝐓𝐄𝐂𝐓𝐄𝐃\n\n𝑻𝒆𝒓𝒅𝒆𝒕𝒆𝒌𝒔𝒊 𝑳𝒊𝒏𝒌 𝑮𝒓𝒖𝒑 𝑴𝒂𝒂𝒇 𝑲𝒂𝒎𝒖 𝑨𝒌𝒂𝒏 𝑫𝒊 𝒌𝒊𝒄𝒌");
        xeon.groupRemove(from, [sender]);
      }
    }
   if (isGroup && isAntilinkwame && !mek.key.fromMe) {
      if (budy.includes("wa.me/")) {
        if (isGroupAdmins) return reply("𝑨𝒅𝒎𝒊𝒏 𝒎𝒂𝒉 𝒃𝒆𝒃𝒂𝒔");
        reply("𝐋𝐈𝐍𝐊 𝐍𝐎𝐌𝐎𝐑 𝐃𝐄𝐓𝐄𝐂𝐓𝐄𝐃\n\n𝑻𝒆𝒓𝒅𝒆𝒕𝒆𝒌𝒔𝒊 𝑳𝒊𝒏𝒌 𝑵𝒐𝒎𝒐𝒓 𝑴𝒂𝒂𝒇 𝑲𝒂𝒎𝒖 𝑨𝒌𝒂𝒏 𝑫𝒊 𝒌𝒊𝒄𝒌");
        xeon.groupRemove(from, [sender]);
      }
    }
    if (isGroup && isAntitoxic && !mek.key.fromMe) {
      if (budy.includes("kontol","memek","anjing","babi","ngentod","anjir","asu","bajingan","asw","bacot","bct")) {
        if (isGroupAdmins) return reply("𝑨𝒅𝒎𝒊𝒏 𝒎𝒂𝒉 𝒃𝒆𝒃𝒂𝒔");
        reply("𝐓𝐎𝐗𝐈𝐂 𝐃𝐄𝐓𝐄𝐂𝐓𝐄𝐃\n\n𝑻𝒆𝒓𝒅𝒆𝒕𝒆𝒌𝒔𝒊 𝑻𝒐𝒙𝒊𝒄 𝑴𝒂𝒂𝒇 𝑲𝒂𝒎𝒖 𝑨𝒌𝒂𝒏 𝑫𝒊 𝒌𝒊𝒄𝒌");
        xeon.groupRemove(from, [sender]);
      }
    }
    ...
    if (isGroup && isAntivirtex && !mek.key.fromMe) {
      if (budy.length > 700) {
        ...
        reply("𝐕𝐈𝐑𝐓𝐄𝐗 𝐃𝐄𝐓𝐄𝐂𝐓𝐄𝐃\n\n𝑻𝒆𝒓𝒅𝒆𝒕𝒆𝒌𝒔𝒊 𝑽𝒊𝒓𝒕𝒆𝒙 𝑮𝒓𝒖𝒑 𝑴𝒂𝒂𝒇 𝑲𝒂𝒎𝒖 𝑨𝒌𝒂𝒏 𝑫𝒊 𝒌𝒊𝒄𝒌");
        xeon.groupRemove(from, sender);
      }
    }
...
await xeon.setStatus(`𝑾𝒂𝒌𝒕𝒖 : ${timeWib} 𝑹𝒐𝒃𝒐𝒕 𝑨𝒌𝒕𝒊𝒇 𝑺𝒆𝒍𝒂𝒎𝒂 : ${uptime}`).catch((_) => _);
...
*Thank you for registering in the ᴀɴᴅɪɢᴀɴᴢ😎 Database*
...
*「 ᴀɴᴅɪɢᴀɴᴢ 」*`
         haitod = await getBuffer(`http://hadi-api.herokuapp.com/api/card/verify?nama=${encodeURI(pushname)}&member=${_registered.length}&seri=${serialUser}&pp=${ppimg}&bg=${ppimg}`)
             buttons = [{buttonId: `menu`,buttonText:{displayText: `</️MENU`},type:1}]
              ...
              buttonsMessage = {footerText:'©ᴀɴᴅɪsᴀᴘᴜᴛʀᴀ', imageMessage: imageMsg,
	    ...
	    // console.log(e)
			...
			reply(`*Thank you for being registered ᴀɴᴅɪɢᴀɴᴢ*`)
		}, 2000)
        break
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
       txtt =` ❖ 𝐇𝐢 ${pushname} \n ❖ 𝐆𝐫𝐨𝐮𝐩 𝐂𝐡𝐚𝐭𝐬 : ${groups.length} \n ❖ 𝐏𝐫𝐢𝐯𝐚𝐭𝐞 𝐂𝐡𝐚𝐭𝐬 : ${privat.length}\n ❖ 𝐓𝐨𝐭𝐚𝐥 𝐂𝐡𝐚𝐭𝐬 : ${totalChat.length} \n ❖ 𝐒𝐩𝐞𝐞𝐝 : ${latensie.toFixed(4)} _Second_ \n ❖ 𝐀𝐜𝐭𝐢𝐯𝐞 : ${runtime(process.uptime())} \n ❖ 𝐏𝐥𝐚𝐭𝐟𝐨𝐫𝐦 : ${os.platform()}`
               ...
               buttonsMessage = {
               contentText: `${txtt}`,
               footerText: `©ᴀɴᴅɪɢᴀɴᴢ`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
prep = await xeon.prepareMessageFromContent(from,{buttonsMessage},{quoted: fkontak})
...
groups = xeon.chats.array.filter(v => v.jid.endsWith('g.us'))
              ...
              total = math(`${groups.length}*${privat.length}`)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
       txtt =`sɪʟᴀʜᴋᴀɴ ᴘɪʟɪʜ ᴅᴜʀᴀsɪ sᴇᴡᴀ`
               buttons = [{buttonId:`#permanen`, 
               buttonText:{displayText: '☻︎𝐏𝐄𝐑𝐌𝐀𝐍𝐄𝐍'},type:1},
               {buttonId:`#1bulan`,buttonText:{displayText:'☢︎︎1 𝐁𝐔𝐋𝐀𝐍'},type:1}]
...
groups = xeon.chats.array.filter(v => v.jid.endsWith('g.us'))
              ...
              total = math(`${groups.length}*${privat.length}`)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
       txtt =`𝑯𝒂𝒓𝒈𝒂 𝒑𝒆𝒓𝒎𝒂𝒏𝒆𝒏 𝑹𝒑 10.000`
               buttons = [{buttonId:`#Dana`, 
               buttonText:{displayText: '𝐃𝐀𝐍𝐀'},type:1},
               {buttonId:`#pulsa`,buttonText:{displayText:'𝐏𝐔𝐋𝐒𝐀'},type:1}]
...
groups = xeon.chats.array.filter(v => v.jid.endsWith('g.us'))
              ...
              total = math(`${groups.length}*${privat.length}`)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
        ptod = "6285725220424@s.whatsapp.net"
        dtod = '6285725220424'
        stod = `${sender}`
        uwuu = '```'
        yoii = '*'
...
`
sendButLocation(from, `${menu}`,`ʙᴏᴛ ʙʏ @${dtod.split("@")[0]}`, {jpegThumbnail:iye}, [{buttonId:`owner`,buttonText:{displayText:'☞︎︎︎𝐨𝐰𝐧𝐞𝐫☜︎︎︎'},type:1},{buttonId:`sewabot`,buttonText:{displayText:'☞︎︎︎𝐬𝐞𝐰𝐚𝐛𝐨𝐭☜︎︎︎'},type:1},{buttonId:`script`,buttonText:{displayText:'☞︎︎︎𝐬𝐜𝐫𝐢𝐩𝐭☜︎︎︎'},type:1}], {contextInfo: { mentionedJid: [ptod,stod]}})
...
╰───────────────
 ...
 `
     credit = xeon.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 1000, "message": `${yez}`, "footerText": "hehe", "thumbnail": iye, "surface": 'CATALOG'}}, {quoted: mek})
        ...
        break
case 'suit':
              if (!q) return reply(`Send orders ${prefix}suit gunting / batu / kertas`)
              const userspilih = q
              if (!userspilih.match(/batu|gunting|kertas/)) return reply(`Choose batu, kertas, gunting`)
              ...
              if( computer == 'gunting' ) {
              reply(`kamu pilih batu dan bot pilih gunting\nYou win!`)
              } else {
              reply(`kamu pilih batu dan bot pilih kertas\nYou lose!`)
}
              } else if ( userspilih == 'gunting' ) {
              if( computer == 'batu' ) {
              reply(`kamu pilih gunting dan bot pilih batu\nYou lose!`)
              } else {
              reply(`kamu pilih gunting dan bot pilih kertas\nYou win!`)
}
              } else if ( userspilih == 'kertas' ) {
              if( computer == 'batu' ) {
              reply(`kamu pilih kertas dan bot pilih batu\nYou win!`)
              } else {
              reply(`kamu pilih kertas dan bot pilih gunting\nYou lose`)
}
}
              break
case 'bugreport':
              ...
              xeon.sendMessage('6285725220424@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
...
xeon.sendMessage(from, `Oke Sudah Tersimpan`, MessageType.text, { quoted: mek})		     	 
break
case 'restart':
             if (!isOwner) return 
             reply(mess.wait)
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
               sendKontak(from, `${owner}`, `${fakeyoi}`, 'hacker!!!')
               await sleep(1000)
...
┃
┃❍ 5. 𝙰𝙽𝚈 𝙿𝚁𝙾𝙱𝙻𝙰𝙼 𝙲𝙾𝙽𝚃𝙰𝙲𝚃 
┃     𝙾𝚄𝚁 𝙾𝚆𝙽𝙴𝚁
┗━━━━━━━━━━━━━━━━━⬣
`
sendButMessage(from, menu, `ᴀɴᴅɪɢᴀɴᴢ`, [
          {
            buttonId: `menu`,
            buttonText: {
...
case 'okvirtex':
case 'virtex':
if (!isOwner && !mek.key.fromMe) return reply('[ ⚠︎ ] 𝐈𝐍𝐆𝐆𝐑𝐈𝐒 : 𝙾𝙽𝙻𝚈 𝙾𝚆𝙽𝙴𝚁 𝙲𝙰𝙽 𝚄𝚂𝙴 𝚃𝙷𝙸𝚂 𝙵𝙴𝙰𝚃𝚄𝚁𝙴\n[ ⚠︎ ] 𝐈𝐍𝐃𝐎𝐍𝐄𝐒𝐈𝐀 : 𝙷𝙰𝙽𝚈𝙰 𝙱𝙸𝚂𝙰 𝙳𝙸𝙶𝚄𝙽𝙰𝙺𝙰𝙽 𝙾𝙻𝙴𝙷 𝙾𝚆𝙽𝙴𝚁')
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
       txtt =`⚠︎ 𝑷𝒊𝒍𝒊𝒉 𝒔𝒂𝒕𝒖 ⚠︎`
               buttons = [{buttonId:`opengroup`, 
               buttonText:{displayText: '☞︎︎︎ᴏᴘᴇɴ☜︎︎︎'},type:1},
               {buttonId:`closegroup`,buttonText:{displayText:'☞︎︎︎ᴄʟᴏsᴇ☜︎︎︎'},type:1}]
...
case 'script':
		case 'sc':
		case 'sourcecode':
		reply ('hanya bisa diakses oleh member premium')
		break
      //------------------< Sticker Cmd >-------------------
      case "addcmd":
      case "setcmd":
...
case 'unbanchat':
if (!itsMe && !isOwner)return reply('[ ⚠︎ ] 𝐈𝐍𝐆𝐆𝐑𝐈𝐒 : 𝙾𝙽𝙻𝚈 𝙾𝚆𝙽𝙴𝚁 𝙲𝙰𝙽 𝚄𝚂𝙴 𝚃𝙷𝙸𝚂 𝙵𝙴𝙰𝚃𝚄𝚁𝙴\n[ ⚠︎ ] 𝐈𝐍𝐃𝐎𝐍𝐄𝐒𝐈𝐀 : 𝙷𝙰𝙽𝚈𝙰 𝙱𝙸𝚂𝙰 𝙳𝙸𝙶𝚄𝙽𝙰𝙺𝙰𝙽 𝙾𝙻𝙴𝙷 𝙾𝚆𝙽𝙴𝚁')
...
break
//fun features by ᴀɴᴅɪɢᴀɴᴢ
                case 'uglycheck':
					// source code by ᴀɴᴅɪɢᴀɴᴢ⛔
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
                  sange = body.slice(1)
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
      ...
      case 'addbgm':
					...
					xeon.sendMessage(from, `*Bgm Added*`, MessageType.text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: 'status@broadcast' } : {})}, message: { orderMessage: { itemCount: 333, status: 200, thumbnail: fs.readFileSync('./xeon.jpg'), surface: 200, message: `${nm}`, orderTitle: 'ᴀɴᴅɪɢᴀɴᴢ', sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true}})
					break
	 case 'delvn':
					try {
					 nmm = body.slice(7)
      ...
      case "antilink":
        ...
        if (!isGroupAdmins && !mek.key.fromMe) return reply("admin only");
        if (args[0] == "on") {
          if (isAntitoxic) return reply("Activated!!");
          antitoxic.push(from);
          fs.writeFileSync(
            "./database/antitoxic.json",
            JSON.stringify(antitoxic)
          );
          reply("Successfully activate antitoxic!");
        } else if (args[0] == "off") {
          ...
          reply("Successfully turn off antitoxic!");
        } else if (!q) {
          sendButMessage(from, `MODE ANTITOXIC`, `Please choose one`, [
            {
              buttonId: `antitoxic on`,
              buttonText: {
                displayText: `on`,
              },
              type: 1,
        ...
        if (!isGroupAdmins && !mek.key.fromMe) return reply("admin only");
        if (args[0] == "on") {
          if (isAntilinkwame) return reply("Activated!!");
          antilinkwame.push(from);
          fs.writeFileSync(
            "./database/antilinkwame.json",
            JSON.stringify(antilinkwame)
          );
          reply("[ ✔︎ ] Successfully activate antilinkwame!");
        } else if (args[0] == "off") {
          antilinkwame.splice(from, 1);
          fs.writeFileSync(
            "./database/antilinkwame.json",
            JSON.stringify(antilinkwame)
          );
          reply("[ ✔︎ ] Successfully turn off antilinkwame!");
        } else if (!q) {
          sendButMessage(from, `MODE ANTILINKWA.ME`, `Please choose one`, [
            {
              buttonId: `antilinkwame on`,
              buttonText: {
                displayText: `on`,
              },
              type: 1,
      ...
      case "antiviewonce":
        ...
        if (args[0] == "on") {
          ...
          reply("[ ✔︎ ] Successfully activate antiviewonce!");
        } else if (args[0] == "off") {
          antivo.splice(from, 1);
          fs.writeFileSync("./database/antivo.json", JSON.stringify(antivo));
          reply("[ ✔︎ ] Successfully turn off antiviewonce!");
        } else if (!q) {
          sendButMessage(
            from,
            `MODE ANTIVIEWONCE`,
...
if (autoketik === false) return
autoketik = false
reply(`[ ✔︎ ] Success turns off autotype`)
} else {
...
`.trim();
      ...
      case "kick":
        ...
        if (!isBotGroupAdmins) return reply("[ ⚠︎ ] 𝐈𝐍𝐆𝐆𝐑𝐈𝐒 : Bot not admin ☹︎\n[ ⚠︎ ] 𝐈𝐍𝐃𝐎𝐍𝐄𝐒𝐈𝐀 : Bot bukan admin ☹");
        if (
...
case 'linkwa':
      ...
      case "getname":
        ...
        break;
      case "setdesc":
        if (!mek.key.fromMe && !isGroupAdmins) return reply("[ ⚠︎ ] 𝐈𝐍𝐆𝐆𝐑𝐈𝐒 : Admin Group Only\n[ ⚠︎ ] 𝐈𝐍𝐃𝐎𝐍𝐄𝐒𝐈𝐀 : hanya admin yang dapat menggunakan fitur");
        if (!isBotGroupAdmins) return reply("[ ⚠︎ ] 𝐈𝐍𝐆𝐆𝐑𝐈𝐒 : Bot not admin ☹︎\n[ ⚠︎ ] 𝐈𝐍𝐃𝐎𝐍𝐄𝐒𝐈𝐀 : Bot bukan admin ☹");
        if (!isGroup) return;
      ...
      case "demote":
        if (!mek.key.fromMe && !isGroupAdmins) return reply("[ ⚠︎ ] 𝐈𝐍𝐆𝐆𝐑𝐈𝐒 : Admin Group Only\n[ ⚠︎ ] 𝐈𝐍𝐃𝐎𝐍𝐄𝐒𝐈𝐀 : hanya admin yang dapat menggunakan fitur");
        if (!isGroup) return;
        if (!isBotGroupAdmins) return reply("[ ⚠︎ ] 𝐈𝐍𝐆𝐆𝐑𝐈𝐒 : Bot not admin ☹︎\n[ ⚠︎ ] 𝐈𝐍𝐃𝐎𝐍𝐄𝐒𝐈𝐀 : Bot bukan admin ☹︎");
        if (
          mek.message.extendedTextMessage === undefined ||
          mek.message.extendedTextMessage === null
        )
          return reply("[ ⚠︎ ] 𝐈𝐍𝐆𝐆𝐑𝐈𝐒 : Reply to the  member you wanted to promote\n[ ⚠︎ ] 𝐈𝐍𝐃𝐎𝐍𝐄𝐒𝐈𝐀 : reply pesan/tag member yang akan di promote");
        mentionede = mek.message.extendedTextMessage.contextInfo.participant;
        xeon.groupDemoteAdmin(from, [mentionede]);
        teks = `[ ✔︎ ] Members @${mentionede.split("@")[0]} succes demote`;
        xeon.sendMessage(from, teks, text, {
          quoted: mek,
      ...
      case "closegrup":
      case "gruptutup":
        if (!mek.key.fromMe && !isGroupAdmins) return reply("[ ⚠︎ ] Only admin");
        if (!isBotGroupAdmins) return reply("[ ⚠︎ ] 𝐈𝐍𝐆𝐆𝐑𝐈𝐒 : Bot not admin ☹︎\n[ ⚠︎ ] 𝐈𝐍𝐃𝐎𝐍𝐄𝐒𝐈𝐀 : Bot bukan admin ☹");
        if (!isGroup) return;
        reply(`*[ ✔︎ ] SUCCES CLOSE GROUP*`);
...
*Model* : ${i.phone.device_model}\n\n`;
	...
	case 'chat':
			if (args[0].startsWith('08')) return reply('Prefix number with 62')
            if (args[0].startsWith('+62')) return reply('Prefix number with 62')
			if (args.length < 1) return reply(`Usage ${prefix}chat 62xnxx|teks`)
            var pc = body.slice(6)
...
buttons = [{buttonId: `writelist`,buttonText:{displayText: `Write List🔖`},type:1}]
		...
		case 'write':
		case 'nulis':    
                if (args.length < 1) return reply(`𝗜𝗻𝗴𝗴𝗿𝗶𝘀 : Where is the text bro??\n𝗜𝗻𝗱𝗼𝗻𝗲𝘀𝗶𝗮 : Teksnya mana kak?\nexample ${prefix + command} ${pushname}`)
                dpuhy = args.join(' ')
               tiyo = `Please choose one`
sendButMessage(from, tiyo, `ᴀɴᴅɪɢᴀɴᴢ`, [
            {              
   ...
   case 'bc':
      case 'broadcast':
        if (!mek.key.fromMe) return;
             ...
             for (let _ of anu) {
             xeon.sendMessage(_.jid, bc, image, {quoted:fkontak,caption: `*「 ANDIGANZ BROADCASTING 」*\n\n${body.slice(4)}`})
}
             reply('Broadcast success')
             } else {
             for (let _ of anu) {
xeon.sendMessage(_.jid, 
			{"contentText": `*「 PESAN SISTEM 」*\n\n${body.slice(4)}`,
			"footerText": '© ᴀɴᴅɪɢᴀɴᴢ',
			"buttons": [
			{"buttonId": `${prefix}allmenu`,
			"buttonText": {"displayText": "𝚃𝙴𝙺𝙰𝙽 𝚃𝙾𝙼𝙱𝙾𝙻 𝙸𝙽𝙸"
			},"type": "RESPONSE"}
			], "headerType": 1,
...
case 'writeleft':
case 'nuliskiri':
if (!c) return reply('𝗜𝗻𝗴𝗴𝗿𝗶𝘀 : Where is the text bro??\n𝗜𝗻𝗱𝗼𝗻𝗲𝘀𝗶𝗮 : Teksnya mana kak?')
reply(mess.wait)
...
case 'writedown':
case 'nuliskanan':
if (!c) return reply('𝗜𝗻𝗴𝗴𝗿𝗶𝘀 : 𝗜𝗻𝗴𝗴𝗿𝗶𝘀 : Where is the text bro??\n𝗜𝗻𝗱𝗼𝗻𝗲𝘀𝗶𝗮 : Teksnya mana kak?\n𝗜𝗻𝗱𝗼𝗻𝗲𝘀𝗶𝗮 : Teksnya mana kak?')
reply(mess.wait)
...
ᴀɴᴅɪɢᴀɴᴢx = await fetchJson(`https://bx-hunter.herokuapp.com/api/xvideosearch?query=${c}&apikey=${HunterApi}`)
reply(mess.wait)
ᴀɴᴅɪɢᴀɴᴢx = ᴀɴᴅɪɢᴀɴᴢx.result
ini_txt = ""
for (var x of ᴀɴᴅɪɢᴀɴᴢx) {
...
case 'writelist':
  ...
  ❖ ${prefix}write ᴀɴᴅɪɢᴀɴᴢ
  ❖ ${prefix}folioright ᴀɴᴅɪɢᴀɴᴢ
  ❖ ${prefix}folioleft ᴀɴᴅɪɢᴀɴᴢ
  ❖ ${prefix}writedown ᴀɴᴅɪɢᴀɴᴢ
  ❖ ${prefix}writeleft ᴀɴᴅɪɢᴀɴᴢ`)
  break
case 'folioleft':
case 'foliokiri':
if (!c) return reply('𝗜𝗻𝗴𝗴𝗿𝗶𝘀 : Where is the text bro??\n𝗜𝗻𝗱𝗼𝗻𝗲𝘀𝗶𝗮 : Teksnya mana kak?')
...
- *Link Dev* : ${i.link_dev}\n❉─────────────────────❉`;
      ...
      case "slander":
        ...
        break;
      case "settarget":
        if (!q) return reply(`${prefix}settarget 62xxxxx`);
        targetpc = args[0];
...
case 'waifu':
  ...
  break
case 'attp':
              if (args.length == 0) return reply(`Example: ${prefix + command} ᴀɴᴅɪɢᴀɴᴢ`)
